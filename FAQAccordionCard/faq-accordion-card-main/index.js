document.addEventListener("DOMContentLoaded", () => {
  ...
  let boxImage = document.querySelector(".top-img");
  ...
  function UserClick(e) {
    if (e.target.className == "list__title") {
      let selectedQuestion = document.querySelector(".list__title--selected");
  ...
  function DisableQuestion(question) {
    question.classList.remove("list__title--selected");
  ...
  function EnableQuestion(question) {
    question.classList.add("list__title--selected");
